    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-md border border-border bg-surface px-4 py-2 font-mono text-sm text-primary outline-none transition-colors focus:border-accent"
        />
      </div>
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="rounded-md border border-border px-5 py-2 text-sm text-secondary transition-colors hover:text-primary"
        >
          Cancel
        </button>
      </div>
